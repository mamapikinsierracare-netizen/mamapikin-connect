...
const guides: Guide[] = [
  ...
  // ========== ADDITIONAL DANGER SIGNS GUIDES ==========
  ...
  // ========== ADDITIONAL BREASTFEEDING GUIDES ==========
  ...
  // ========== ADDITIONAL NEWBORN CARE GUIDES ==========
            ...
            <button
              onClick={() => {
                const printContent = `
                  ...
                  <body><h1>${selectedGuide.title}</h1><p>${selectedGuide.description}</p>
                  <p>${selectedGuide.content}</p><hr><p>MamaPikin Connect</p></body></html>
                `
